...
void draw_color_card(int player, int nb_players, int **card_hand, int *nb_cards,
                     int *wagon_cards_modif, int **cards, int nb_colors, int *col,int colored_game);
 ...
 * @param player id of the player who is playing
 * @param nb_players
 * @param obj_hands matrix whith all objs of each player
 * @param nb_objs_total number of total objectives in the game
 * @param objs_cond array of boleans 1=player draws this onjective, 0=he doesn't
 * @param new_objs array of new objs for each player
...
void draw_objectives(int player, int nb_players, int **obj_hands,/*int nb_objs_player,
                    ...
                    int **new_objs, int nb_objs_drawn_max, int min_objs_to_pick,
                    struct f_player * player_fonctions, int *nb_objs,int * nb_new_objs);
...
/**
 * @brief apply apply in the server and for the players the modifications caused by the action of a player
 * @param player id of the player who is playing
 * @param action action chose by the player
 * @param nb_players
 * @param card_hand
 * @param nb_cards
 * @param wagon_cards_modif
 * @param cards
 * @param nb_colors
 * @param col
 * @param map
 * @param rails
 * @param wagons_remaining
 * @param used_wagons
 * @param obj_hands
 * @param nb_objs_total
 * @param objs_cond
 * @param new_objs
 * @param nb_objs_drawn_max
 * @param min_objs_to_pick
 * @param player_fonctions
 * @param nb_objs
 * @param nb_new_objs
 * @param colored_game
 */
void apply(int player, struct Action action,int nb_players,int **card_hand,
       ...
       int nb_objs_drawn_max, int min_objs_to_pick, struct f_player * player_fonctions, int *nb_objs, int * nb_new_objs,int colored_game);

/**
 * @brief winner determined who is the winner (by counting rails points and objectives points)
 * @param map
 * @param nb_towns
 * @param nb_players
 * @param all_objectives
 * @param obj_hands
 * @param nb_objs
 * @param nb_rails
 * @param rails
...
/**
 * @brief points_rails add rails points of each player, in the array points
 * @param map
 * @param nb_towns
 * @param nb_players
 * @param points
...
/**
 * @brief points_objs add points of objectives which have been done points of each player, in the array points
 * @param map
 * @param nb_towns
 * @param nb_players
 * @param all_objectives
...
/**
 * @brief free_all free all the memory which have been used for the game
 * @param col
 * @param nb_towns
 * @param map
 * @param nb_players
