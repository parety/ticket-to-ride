...
void test_init_map(){
    ...
    railTest[0].color=0;
    railTest[0].length=2;
    railTest[0].town1=1; // Attention !! Town1=1 et non 0!
    railTest[0].town2=2;
    railTest[1].color=4;
    railTest[1].length=1;
    railTest[1].town1=1;
    ...
    struct Link ** tab = init_map(3,railTest,2);
    printf("        initialisation:    ");
    assert(tab[1][2].nbr_way == 2);
    assert(tab[1][2].tab_rails[1].rail->color == 4);
    assert(tab[1][2].tab_rails[1].rail->length == 1);
    assert(tab[1][2].tab_rails[1].rail->town1 == 1);
    assert(tab[1][2].tab_rails[1].rail->town2 == 2);
    assert(tab[1][2].tab_rails[1].id_player == -1);
    assert(tab[1][2].tab_rails[1].id_rail == 1);
    printf("ok\n");
    printf("        test give_my_rail:    ");
    struct My_Rail * res = give_my_rail(1,tab,railTest);
    assert(res->rail->color == tab[1][2].tab_rails[1].rail->color);
    assert(res->rail->length == tab[1][2].tab_rails[1].rail->length);
    assert(res->rail->town1 == tab[1][2].tab_rails[1].rail->town1);
    assert(res->rail->town2 == tab[1][2].tab_rails[1].rail->town2);
    assert(res->id_player == tab[1][2].tab_rails[1].id_player);
    assert(res->id_rail == tab[1][2].tab_rails[1].id_rail);
    printf("ok\n");
